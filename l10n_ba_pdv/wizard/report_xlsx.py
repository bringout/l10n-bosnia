...
class PdvXlsx(models.AbstractModel):
    ...
    def _enabavke(self, workbook, data, data2):
        ...
        sheet_nab.set_column('D:E', 12) #datumi
        sheet_nab.set_column('F:G', 40) #dob
        sheet_nab.set_column('H:I', 20) #pdv
        sheet_nab.set_column('J:R', 20)

        for header in ['por_per', 'enabavke_id', 'tip', 'dat fakt', 'dat prijem', "dobavlj naziv", "dobav sljedište", "dob_pdv", "dob_id", 
        ...
        while True:
            ...
            col += 1
            sheet_nab.write(row, col, "02" if (nabavka.fakt_iznos_pdv_np > nabavka.fakt_iznos_pdv) else "01") # moze biti 1 ili 2    nabavka.br_fakt,
            col += 1
            ...
            col += 1
            sheet_nab.write(row, col, nabavka.dob_jib if nabavka.dob_pdv else "".rjust(13, "9"))
            col += 1
    ...
    def _eisporuke(self, workbook, data, data2):
        ...
        while True:
            ...
            col += 1
            sheet_nab.write(row, col, self._eisporuke_get_tip(isporuka)),
            col += 1
